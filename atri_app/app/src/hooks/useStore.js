...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image_arro": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/5ff019fc559a4200eda62273_Vector%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Text_des1": {
      "custom": {
        "text": "Faster, better products that your users love. Here's all the services "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image73": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/604788d804dfe4ec1de7bb97_imageressed-p-500.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
