...
class Atri:
	def __init__(self, state: Any):
		...
		self.Flex_header = state["Flex_header"]
		self.flex_nav = state["flex_nav"]
		self.div_nav = state["div_nav"]
		self.Flex_main = state["Flex_main"]
		self.Flex_home_hero = state["Flex_home_hero"]
		self.Div_home = state["Div_home"]
		self.Flex_cv = state["Flex_cv"]
		self.Flex_trustedmain = state["Flex_trustedmain"]
		self.Flex_trustedby = state["Flex_trustedby"]
		self.Div5 = state["Div5"]
		self.Flex13 = state["Flex13"]
		self.Flex_servicem = state["Flex_servicem"]
		self.Flex_service = state["Flex_service"]
		self.Div7 = state["Div7"]
		self.Div8 = state["Div8"]
		self.Flex17 = state["Flex17"]
		self.Service1 = state["Service1"]
		self.Flex_icon1 = state["Flex_icon1"]
		self.Div17 = state["Div17"]
		self.Div_des1 = state["Div_des1"]
		...
		self.Service2 = state["Service2"]
		self.Flex_icon2 = state["Flex_icon2"]
		...
		self.Service3 = state["Service3"]
		self.Flex_icon3 = state["Flex_icon3"]
		...
		self.Footer_div = state["Footer_div"]
		self.Flex_footer = state["Flex_footer"]
		self.Flex210 = state["Flex210"]
		self.Flex211 = state["Flex211"]
		self.Div_footertext = state["Div_footertext"]
		self.Flexfooter = state["Flexfooter"]
		...
		self.Image_p = state["Image_p"]
		self.Link_b = state["Link_b"]
		self.Link_s = state["Link_s"]
		self.Link_a = state["Link_a"]
		self.Link_book = state["Link_book"]
		self.Link_p = state["Link_p"]
		self.Image_arrow = state["Image_arrow"]
		self.Image_home = state["Image_home"]
		self.TextBox_design = state["TextBox_design"]
		self.TextBox_heading = state["TextBox_heading"]
		self.TextBox_des = state["TextBox_des"]
		self.Button_call = state["Button_call"]
		self.Link7 = state["Link7"]
		self.Image_arro = state["Image_arro"]
		self.Text_trustedby = state["Text_trustedby"]
		self.Image7 = state["Image7"]
		self.Image8 = state["Image8"]
		self.Image9 = state["Image9"]
		self.Image10 = state["Image10"]
		self.Text_service = state["Text_service"]
		self.Text_des = state["Text_des"]
		self.Img_icon1 = state["Img_icon1"]
		self.Text_Service1 = state["Text_Service1"]
		self.Text_des1 = state["Text_des1"]
		...
		self.Img_icon2 = state["Img_icon2"]
		...
		self.Img_icon3 = state["Img_icon3"]
		...
		self.FooterText_1 = state["FooterText_1"]
		self.FooterText_2 = state["FooterText_2"]
	...
	@property
	def Flex_header(self):
		self._getter_access_tracker["Flex_header"] = {}
		return self._Flex_header
	@Flex_header.setter
	def Flex_header(self, new_state):
		self._setter_access_tracker["Flex_header"] = {}
		global default_state
		self._Flex_header = Flex(new_state, default_state["Flex_header"])

	@property
	def flex_nav(self):
		self._getter_access_tracker["flex_nav"] = {}
		return self._flex_nav
	@flex_nav.setter
	def flex_nav(self, new_state):
		self._setter_access_tracker["flex_nav"] = {}
		global default_state
		self._flex_nav = Flex(new_state, default_state["flex_nav"])

	@property
	def div_nav(self):
		self._getter_access_tracker["div_nav"] = {}
		return self._div_nav
	@div_nav.setter
	def div_nav(self, new_state):
		self._setter_access_tracker["div_nav"] = {}
		global default_state
		self._div_nav = Div(new_state, default_state["div_nav"])

	@property
	def Flex_main(self):
		self._getter_access_tracker["Flex_main"] = {}
		return self._Flex_main
	@Flex_main.setter
	def Flex_main(self, new_state):
		self._setter_access_tracker["Flex_main"] = {}
		global default_state
		self._Flex_main = Flex(new_state, default_state["Flex_main"])

	@property
	def Flex_home_hero(self):
		self._getter_access_tracker["Flex_home_hero"] = {}
		return self._Flex_home_hero
	@Flex_home_hero.setter
	def Flex_home_hero(self, new_state):
		self._setter_access_tracker["Flex_home_hero"] = {}
		global default_state
		self._Flex_home_hero = Flex(new_state, default_state["Flex_home_hero"])

	@property
	def Div_home(self):
		self._getter_access_tracker["Div_home"] = {}
		return self._Div_home
	@Div_home.setter
	def Div_home(self, new_state):
		self._setter_access_tracker["Div_home"] = {}
		global default_state
		self._Div_home = Div(new_state, default_state["Div_home"])

	@property
	def Flex_cv(self):
		self._getter_access_tracker["Flex_cv"] = {}
		return self._Flex_cv
	@Flex_cv.setter
	def Flex_cv(self, new_state):
		self._setter_access_tracker["Flex_cv"] = {}
		global default_state
		self._Flex_cv = Flex(new_state, default_state["Flex_cv"])

	@property
	def Flex_trustedmain(self):
		self._getter_access_tracker["Flex_trustedmain"] = {}
		return self._Flex_trustedmain
	@Flex_trustedmain.setter
	def Flex_trustedmain(self, new_state):
		self._setter_access_tracker["Flex_trustedmain"] = {}
		global default_state
		self._Flex_trustedmain = Flex(new_state, default_state["Flex_trustedmain"])

	@property
	def Flex_trustedby(self):
		self._getter_access_tracker["Flex_trustedby"] = {}
		return self._Flex_trustedby
	@Flex_trustedby.setter
	def Flex_trustedby(self, new_state):
		self._setter_access_tracker["Flex_trustedby"] = {}
		global default_state
		self._Flex_trustedby = Flex(new_state, default_state["Flex_trustedby"])
	...
	@property
	def Flex_servicem(self):
		self._getter_access_tracker["Flex_servicem"] = {}
		return self._Flex_servicem
	@Flex_servicem.setter
	def Flex_servicem(self, new_state):
		self._setter_access_tracker["Flex_servicem"] = {}
		global default_state
		self._Flex_servicem = Flex(new_state, default_state["Flex_servicem"])

	@property
	def Flex_service(self):
		self._getter_access_tracker["Flex_service"] = {}
		return self._Flex_service
	@Flex_service.setter
	def Flex_service(self, new_state):
		self._setter_access_tracker["Flex_service"] = {}
		global default_state
		self._Flex_service = Flex(new_state, default_state["Flex_service"])
	...
	@property
	def Service1(self):
		self._getter_access_tracker["Service1"] = {}
		return self._Service1
	@Service1.setter
	def Service1(self, new_state):
		self._setter_access_tracker["Service1"] = {}
		global default_state
		self._Service1 = Div(new_state, default_state["Service1"])

	@property
	def Flex_icon1(self):
		self._getter_access_tracker["Flex_icon1"] = {}
		return self._Flex_icon1
	@Flex_icon1.setter
	def Flex_icon1(self, new_state):
		self._setter_access_tracker["Flex_icon1"] = {}
		global default_state
		self._Flex_icon1 = Flex(new_state, default_state["Flex_icon1"])
	...
	@property
	def Div_des1(self):
		self._getter_access_tracker["Div_des1"] = {}
		return self._Div_des1
	@Div_des1.setter
	def Div_des1(self, new_state):
		self._setter_access_tracker["Div_des1"] = {}
		global default_state
		self._Div_des1 = Div(new_state, default_state["Div_des1"])
	...
	@property
	def Service2(self):
		self._getter_access_tracker["Service2"] = {}
		return self._Service2
	@Service2.setter
	def Service2(self, new_state):
		self._setter_access_tracker["Service2"] = {}
		global default_state
		self._Service2 = Div(new_state, default_state["Service2"])

	@property
	def Flex_icon2(self):
		self._getter_access_tracker["Flex_icon2"] = {}
		return self._Flex_icon2
	@Flex_icon2.setter
	def Flex_icon2(self, new_state):
		self._setter_access_tracker["Flex_icon2"] = {}
		global default_state
		self._Flex_icon2 = Flex(new_state, default_state["Flex_icon2"])
	...
	@property
	def Service3(self):
		self._getter_access_tracker["Service3"] = {}
		return self._Service3
	@Service3.setter
	def Service3(self, new_state):
		self._setter_access_tracker["Service3"] = {}
		global default_state
		self._Service3 = Div(new_state, default_state["Service3"])

	@property
	def Flex_icon3(self):
		self._getter_access_tracker["Flex_icon3"] = {}
		return self._Flex_icon3
	@Flex_icon3.setter
	def Flex_icon3(self, new_state):
		self._setter_access_tracker["Flex_icon3"] = {}
		global default_state
		self._Flex_icon3 = Flex(new_state, default_state["Flex_icon3"])
	...
	@property
	def Footer_div(self):
		self._getter_access_tracker["Footer_div"] = {}
		return self._Footer_div
	@Footer_div.setter
	def Footer_div(self, new_state):
		self._setter_access_tracker["Footer_div"] = {}
		global default_state
		self._Footer_div = Div(new_state, default_state["Footer_div"])

	@property
	def Flex_footer(self):
		self._getter_access_tracker["Flex_footer"] = {}
		return self._Flex_footer
	@Flex_footer.setter
	def Flex_footer(self, new_state):
		self._setter_access_tracker["Flex_footer"] = {}
		global default_state
		self._Flex_footer = Flex(new_state, default_state["Flex_footer"])
	...
	@property
	def Div_footertext(self):
		self._getter_access_tracker["Div_footertext"] = {}
		return self._Div_footertext
	@Div_footertext.setter
	def Div_footertext(self, new_state):
		self._setter_access_tracker["Div_footertext"] = {}
		global default_state
		self._Div_footertext = Div(new_state, default_state["Div_footertext"])

	@property
	def Flexfooter(self):
		self._getter_access_tracker["Flexfooter"] = {}
		return self._Flexfooter
	@Flexfooter.setter
	def Flexfooter(self, new_state):
		self._setter_access_tracker["Flexfooter"] = {}
		global default_state
		self._Flexfooter = Flex(new_state, default_state["Flexfooter"])
	...
	@property
	def Image_p(self):
		self._getter_access_tracker["Image_p"] = {}
		return self._Image_p
	@Image_p.setter
	def Image_p(self, new_state):
		self._setter_access_tracker["Image_p"] = {}
		global default_state
		self._Image_p = Image(new_state, default_state["Image_p"])

	@property
	def Link_b(self):
		self._getter_access_tracker["Link_b"] = {}
		return self._Link_b
	@Link_b.setter
	def Link_b(self, new_state):
		self._setter_access_tracker["Link_b"] = {}
		global default_state
		self._Link_b = Link(new_state, default_state["Link_b"])

	@property
	def Link_s(self):
		self._getter_access_tracker["Link_s"] = {}
		return self._Link_s
	@Link_s.setter
	def Link_s(self, new_state):
		self._setter_access_tracker["Link_s"] = {}
		global default_state
		self._Link_s = Link(new_state, default_state["Link_s"])

	@property
	def Link_a(self):
		self._getter_access_tracker["Link_a"] = {}
		return self._Link_a
	@Link_a.setter
	def Link_a(self, new_state):
		self._setter_access_tracker["Link_a"] = {}
		global default_state
		self._Link_a = Link(new_state, default_state["Link_a"])

	@property
	def Link_book(self):
		self._getter_access_tracker["Link_book"] = {}
		return self._Link_book
	@Link_book.setter
	def Link_book(self, new_state):
		self._setter_access_tracker["Link_book"] = {}
		global default_state
		self._Link_book = Link(new_state, default_state["Link_book"])

	@property
	def Link_p(self):
		self._getter_access_tracker["Link_p"] = {}
		return self._Link_p
	@Link_p.setter
	def Link_p(self, new_state):
		self._setter_access_tracker["Link_p"] = {}
		global default_state
		self._Link_p = Link(new_state, default_state["Link_p"])

	@property
	def Image_arrow(self):
		self._getter_access_tracker["Image_arrow"] = {}
		return self._Image_arrow
	@Image_arrow.setter
	def Image_arrow(self, new_state):
		self._setter_access_tracker["Image_arrow"] = {}
		global default_state
		self._Image_arrow = Image(new_state, default_state["Image_arrow"])

	@property
	def Image_home(self):
		self._getter_access_tracker["Image_home"] = {}
		return self._Image_home
	@Image_home.setter
	def Image_home(self, new_state):
		self._setter_access_tracker["Image_home"] = {}
		global default_state
		self._Image_home = Image(new_state, default_state["Image_home"])

	@property
	def TextBox_design(self):
		self._getter_access_tracker["TextBox_design"] = {}
		return self._TextBox_design
	@TextBox_design.setter
	def TextBox_design(self, new_state):
		self._setter_access_tracker["TextBox_design"] = {}
		global default_state
		self._TextBox_design = TextBox(new_state, default_state["TextBox_design"])

	@property
	def TextBox_heading(self):
		self._getter_access_tracker["TextBox_heading"] = {}
		return self._TextBox_heading
	@TextBox_heading.setter
	def TextBox_heading(self, new_state):
		self._setter_access_tracker["TextBox_heading"] = {}
		global default_state
		self._TextBox_heading = TextBox(new_state, default_state["TextBox_heading"])

	@property
	def TextBox_des(self):
		self._getter_access_tracker["TextBox_des"] = {}
		return self._TextBox_des
	@TextBox_des.setter
	def TextBox_des(self, new_state):
		self._setter_access_tracker["TextBox_des"] = {}
		global default_state
		self._TextBox_des = TextBox(new_state, default_state["TextBox_des"])

	@property
	def Button_call(self):
		self._getter_access_tracker["Button_call"] = {}
		return self._Button_call
	@Button_call.setter
	def Button_call(self, new_state):
		self._setter_access_tracker["Button_call"] = {}
		global default_state
		self._Button_call = Button(new_state, default_state["Button_call"])
	...
	@property
	def Image_arro(self):
		self._getter_access_tracker["Image_arro"] = {}
		return self._Image_arro
	@Image_arro.setter
	def Image_arro(self, new_state):
		self._setter_access_tracker["Image_arro"] = {}
		global default_state
		self._Image_arro = Image(new_state, default_state["Image_arro"])

	@property
	def Text_trustedby(self):
		self._getter_access_tracker["Text_trustedby"] = {}
		return self._Text_trustedby
	@Text_trustedby.setter
	def Text_trustedby(self, new_state):
		self._setter_access_tracker["Text_trustedby"] = {}
		global default_state
		self._Text_trustedby = TextBox(new_state, default_state["Text_trustedby"])
	...
	def Text_service(self):
		self._getter_access_tracker["Text_service"] = {}
		return self._Text_service
	@Text_service.setter
	def Text_service(self, new_state):
		self._setter_access_tracker["Text_service"] = {}
		global default_state
		self._Text_service = TextBox(new_state, default_state["Text_service"])

	@property
	def Text_des(self):
		self._getter_access_tracker["Text_des"] = {}
		return self._Text_des
	@Text_des.setter
	def Text_des(self, new_state):
		self._setter_access_tracker["Text_des"] = {}
		global default_state
		self._Text_des = TextBox(new_state, default_state["Text_des"])

	@property
	def Img_icon1(self):
		self._getter_access_tracker["Img_icon1"] = {}
		return self._Img_icon1
	@Img_icon1.setter
	def Img_icon1(self, new_state):
		self._setter_access_tracker["Img_icon1"] = {}
		global default_state
		self._Img_icon1 = Image(new_state, default_state["Img_icon1"])

	@property
	def Text_Service1(self):
		self._getter_access_tracker["Text_Service1"] = {}
		return self._Text_Service1
	@Text_Service1.setter
	def Text_Service1(self, new_state):
		self._setter_access_tracker["Text_Service1"] = {}
		global default_state
		self._Text_Service1 = TextBox(new_state, default_state["Text_Service1"])

	@property
	def Text_des1(self):
		self._getter_access_tracker["Text_des1"] = {}
		return self._Text_des1
	@Text_des1.setter
	def Text_des1(self, new_state):
		self._setter_access_tracker["Text_des1"] = {}
		global default_state
		self._Text_des1 = TextBox(new_state, default_state["Text_des1"])
	...
	@property
	def Img_icon2(self):
		self._getter_access_tracker["Img_icon2"] = {}
		return self._Img_icon2
	@Img_icon2.setter
	def Img_icon2(self, new_state):
		self._setter_access_tracker["Img_icon2"] = {}
		global default_state
		self._Img_icon2 = Image(new_state, default_state["Img_icon2"])
	...
	@property
	def Img_icon3(self):
		self._getter_access_tracker["Img_icon3"] = {}
		return self._Img_icon3
	@Img_icon3.setter
	def Img_icon3(self, new_state):
		self._setter_access_tracker["Img_icon3"] = {}
		global default_state
		self._Img_icon3 = Image(new_state, default_state["Img_icon3"])
	...
	@property
	def FooterText_1(self):
		self._getter_access_tracker["FooterText_1"] = {}
		return self._FooterText_1
	@FooterText_1.setter
	def FooterText_1(self, new_state):
		self._setter_access_tracker["FooterText_1"] = {}
		global default_state
		self._FooterText_1 = TextBox(new_state, default_state["FooterText_1"])

	@property
	def FooterText_2(self):
		self._getter_access_tracker["FooterText_2"] = {}
		return self._FooterText_2
	@FooterText_2.setter
	def FooterText_2(self, new_state):
		self._setter_access_tracker["FooterText_2"] = {}
		global default_state
		self._FooterText_2 = TextBox(new_state, default_state["FooterText_2"])
	...
	def _to_json_fields(self):
		return {
			"Flex_header": self._Flex_header,
			"flex_nav": self._flex_nav,
			"div_nav": self._div_nav,
			"Flex_main": self._Flex_main,
			"Flex_home_hero": self._Flex_home_hero,
			"Div_home": self._Div_home,
			"Flex_cv": self._Flex_cv,
			"Flex_trustedmain": self._Flex_trustedmain,
			"Flex_trustedby": self._Flex_trustedby,
			"Div5": self._Div5,
			"Flex13": self._Flex13,
			"Flex_servicem": self._Flex_servicem,
			"Flex_service": self._Flex_service,
			"Div7": self._Div7,
			"Div8": self._Div8,
			"Flex17": self._Flex17,
			"Service1": self._Service1,
			"Flex_icon1": self._Flex_icon1,
			"Div17": self._Div17,
			"Div_des1": self._Div_des1,
			"Div95": self._Div95,
			...
			"Service3": self._Service3,
			"Flex_icon3": self._Flex_icon3,
			"Div93": self._Div93,
			"Div92": self._Div92,
			"Div97": self._Div97,
			...
			"Footer_div": self._Footer_div,
			"Flex_footer": self._Flex_footer,
			"Flex210": self._Flex210,
			"Flex211": self._Flex211,
			"Div_footertext": self._Div_footertext,
			"Flexfooter": self._Flexfooter,
			"Div167": self._Div167,
			...
			"Div170": self._Div170,
			"Image_p": self._Image_p,
			"Link_b": self._Link_b,
			"Link_s": self._Link_s,
			"Link_a": self._Link_a,
			"Link_book": self._Link_book,
			"Link_p": self._Link_p,
			"Image_arrow": self._Image_arrow,
			"Image_home": self._Image_home,
			"TextBox_design": self._TextBox_design,
			"TextBox_heading": self._TextBox_heading,
			"TextBox_des": self._TextBox_des,
			"Button_call": self._Button_call,
			"Link7": self._Link7,
			"Image_arro": self._Image_arro,
			"Text_trustedby": self._Text_trustedby,
			"Image7": self._Image7,
			"Image8": self._Image8,
			"Image9": self._Image9,
			"Image10": self._Image10,
			"Text_service": self._Text_service,
			"Text_des": self._Text_des,
			"Img_icon1": self._Img_icon1,
			"Text_Service1": self._Text_Service1,
			"Text_des1": self._Text_des1,
			...
			"FooterText_1": self._FooterText_1,
			"FooterText_2": self._FooterText_2,
